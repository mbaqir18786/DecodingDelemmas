          ...
          <form>
            <div className="input-grid">
              ...
              <div className="input-group">
                ...
                <input type="tel" id="contact-no" placeholder="+91 98765 43210" required />
              </div>
...
<div className="contact-section">
  ...
  <div className="connect">
    ...
    <div className="social-icons">
      <a href="https://www.instagram.com/alumnicell_kjsce/"><i className="fab fa-instagram" ></i></a>
      <a href="https://www.linkedin.com/in/alumnicellkjsce/"><i className="fab fa-linkedin"></i></a>
      <a href="mailto:alumni.engg@somaiya.edu"><i className="fas fa-envelope"></i></a>
    </div>
  </div>
</div>
        </div>
